...
from ..schemas.access_policy import AccessPolicyCreate, AccessPolicyUpdate
...
def register_admin_views(admin: CRUDAdmin) -> None:
    ...
    # Register AccessPolicy with the admin interface so policies can be managed
    admin.add_view(
        model=AccessPolicy,
        create_schema=AccessPolicyCreate,
        update_schema=AccessPolicyUpdate,
        allowed_actions={"view", "create", "delete"},
    )
