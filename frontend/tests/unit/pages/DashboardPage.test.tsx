...
describe("DashboardPage", () => {
	it("shows the signed-in profile, role, summaries, and approval queue when permitted", () => {
		...
		vi.mocked(usePosts).mockReturnValue({
			...
			response: null,
			posts: [
				{ createdAt: "2026-03-18T00:00:00Z", createdByUserId: 7, mediaUrl: null, status: "draft", text: "A", title: "A", uuid: "post-uuid-1" },
				{ createdAt: "2026-03-18T00:00:00Z", createdByUserId: 7, mediaUrl: null, status: "in_review", text: "B", title: "B", uuid: "post-uuid-2" },
				{ createdAt: "2026-03-18T00:00:00Z", createdByUserId: 7, mediaUrl: null, status: "approved", text: "C", title: "C", uuid: "post-uuid-3" },
			],
		});
